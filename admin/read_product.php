    ...
    <form class="form-horizontal" action="<?php $_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <label class="control-label col-sm-2" for="email" style="text-align:left">Tên sản phẩm</label>
                <div class="col-sm-3">
                  <input type="text" class="form-control" name="NameProduct" id="NameProduct" placeholder="Nhập tên sản phẩm" value= "<?php echo $cate['NameProduct'] ?> ">
                </div>
    
              <label class="control-label col-sm-2" for="pl" style="text-align:left">Nhà cung cấp</label>
                <div class="col-sm-3">
                  <input type="text" class="form-control" name="Type" id="Type" placeholder="Nhập phân loại"value= "<?php echo $cate['Type'] ?> ">
                </div>
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="msp" style="text-align:left">Mã sản phẩm</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="Code" id="Code" placeholder="Nhập mã sản phẩm" value= "<?php echo $cate['Code'] ?> ">
                  </div>
                <!-- <label class="control-label col-sm-2" for="nhan" style="text-align:left">Nhãn của sản phẩm</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="Tag" id="Tag" placeholder="Nhãn của sản phẩm" value= "<?php echo $cate['Tag'] ?> ">
                  </div> -->
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="gia" style="text-align:left">Giá bán</label>
                ...
                <div class="col-sm-3">
                  ...
                  <button class="btn btn-success" name="saveproduct" style="margin-left:100px">Cập nhật</button>
                </div>
            ...
            <div class="form-group">
              <!-- <label class="control-label col-sm-2" for="giakm" style="text-align:left">Giá khuyến mãi</label>
                <div class="col-sm-3">
                  <input type="text" class="form-control" name="Price1" id="Price1" placeholder="Nhập giá khuyễn mãi" value= "<?php echo $cate['Price1'] ?> ">
                </div> -->
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="sl" style="text-align:left">Số lượng</label>
                <div class="col-sm-3">
                  <input type="sl" class="form-control" name="Amount" id="Amount" placeholder="Nhập số lượng" value= "<?php echo $cate['Amount'] ?> ">
                </div>
            </div>
            <div class="form-group">
